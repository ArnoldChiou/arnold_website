...
const Header: React.FC<HeaderProps> = ({ siteTitle }) => {
  ...
  const handleSearchClick = () => {
    ...
    console.log('Search button clicked. Search active:', !isSearchActive);
  };
      ...
      <div className="header-container">
        ...
        <div className="header-actions">
          ...
          <button className="theme-toggle" aria-label="Toggle theme" onClick={handleThemeToggle}>
            {theme === 'light' ? (
              <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg"> {/* Sun icon */}
              ...
              <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg"> {/* Moon icon */}
